...
fn get_data_provider_logic(
    ...
    let default_table_provider_impl = if impl_default_provider {
        quote! {
            #[async_trait(?Send)]
            ...
            #where_clause
            {
                ...
                async fn get_rows(&self, range: std::ops::Range<usize> ) -> Vec<#ident #generic_params> {
    ...
    quote! {
        ...
        /// Generated by leptos-struct-table-macro
        #[derive(PartialEq)]
        pub enum #column_value_enum #generic_params
        #where_clause
        {
            #(#column_value_variants)*
        }

        impl #generic_params PartialOrd for #column_value_enum #generic_params
        #where_clause
        {
        ...
        impl #generic_params #ident #generic_params
        #where_clause
        {
            /// Generated by leptos-struct-table-macro
            pub fn get(&self, column: #column_name_enum) -> #column_value_enum #generic_params {
                match column {
...
impl ToTokens for TableComponentDeriveInput {
    fn to_tokens(&self, tokens: &mut TokenStream2) {
        ...
        let table_data_provider_ident = table_data_provider
            .as_ref()
            .map(|id| id.to_string())
            .unwrap_or("TableDataProvider".to_string());

        let table_data_provider_ident =
            syn::Ident::new(&table_data_provider_ident, table_data_provider.span());
        ...
        tokens.extend(quote! {
            ...
            #[component]
            pub fn #component_ident<Row, #generic_params>(
                ...
                #[prop(optional, into)]
                on_change: ChangeEventHandler<#ident #generic_params_wb, #column_name_enum, #column_value_enum #generic_params_wb>,

                #selection_prop
            ) -> impl IntoView
            where
                Row: #table_data_provider_ident<#ident #generic_params_wb, ColumnName = #column_name_enum> + Clone + PartialEq + core::fmt::Debug + 'static,
                #where_predicates
            {
