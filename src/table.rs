            ...
            Ok(inner_type_ident) => {
                ...
                quote! {
                    <Show when=move || { item_signal.get_untracked().#getter.is_some() }
                        fallback=move || view!{<DefaultTableCellRenderer value=#none_value.to_string() #class_prop #index_prop/>}
                    >
                        #inner_renderer
                    </Show>
                }
...
fn get_selection_logic(
    ...
    match selection_mode {
        ...
        SelectionMode::Single => (
            ...
            quote! {create_selector(selected_key)},
        ),
...
impl ToTokens for TableComponentDeriveInput {
    fn to_tokens(&self, tokens: &mut TokenStream2) {
        ...
        for f in fields.into_iter() {
            ...
            titles.push(quote! {
                <#head_renderer
                    class=Signal::derive(move || class_provider.clone().head_cell(column_sort.clone()(#column_name_enum::#column_name_variant), #head_class))
                    ...
                    sort_direction=Signal::derive(move || column_sort.clone()(#column_name_enum::#column_name_variant))
